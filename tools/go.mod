module github.com/x0rzkov/kahoot-exporter

go 1.13

require (
	9fans.net/go v0.0.2 // indirect
	github.com/DamnWidget/godef v0.0.0-20160905114020-c8917eb96a3d // indirect
	...
	github.com/qor/admin v0.0.0-20191226032843-24c19e4f3c63
